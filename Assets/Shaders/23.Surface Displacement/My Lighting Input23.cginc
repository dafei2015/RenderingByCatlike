...
#if !defined(MY_LIGHTING_INPUT23_INCLUDED)
    #define MY_LIGHTING_INPUT23_INCLUDED
...
//Unity 在2017.3年再次改变了它的方法，因此额外的方向灯被支持，但是这给我们的工作区和未来的照明工作带来了麻烦。快速解决方法是禁用我们的变通方法。
