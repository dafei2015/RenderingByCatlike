...
// Upgrade NOTE: replaced 'mul(UNITY_MATRIX_MVP,*)' with 'UnityObjectToClipPos(*)'
//BRDF 表示双向反射分布函数
Shader "Custom/My Mixed Lighting Shader"
{
...
//        
        Pass
        {
            ...
            // #define POINT;
            #include "../16.Static Lighting/My Shadows16.cginc"
        ...
        Pass
        {
			...
			#pragma shader_feature _DETAIL_ALBEDO_MAP
            // #define POINT;
            #include "../16.Static Lighting/My Lightmapping16.cginc"
